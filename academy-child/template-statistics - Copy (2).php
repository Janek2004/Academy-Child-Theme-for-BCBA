<strong><div id="themex-statistics" class="themex-statistics wrap">
	...
	<div id="poststuff">
    	<?php if(isset($_GET['course_id']) && isset($_GET['lesson_id'])){ ?>
       	<?php 
			...
			$arrayAnswers=mysql_query("Select meta_value FROM wp-usermeta WHERE user_id=$user_id AND meta_key LIKE '%userAns_%'");	
